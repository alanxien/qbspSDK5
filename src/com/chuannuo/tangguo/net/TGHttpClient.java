 ...
 * {@link TGHttpResponseHandler} instance.
 * <p>
 * For example:
 * <p>
 * <pre>
...
public class TGHttpClient {
    ...
    public static final String LOG_TAG = "HCKHttpClient";
   ...
   /**
     ...
     */
    public void get(String url, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void get(String url, RequestParams params, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void get(Context context, String url, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void get(Context context, String url, RequestParams params, TGHttpResponseHandler responseHandler) {
     ...
     *        the response.
     */
    public void get(Context context, String url, Header[] headers, RequestParams params, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(String url, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(String url, RequestParams params, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(Context context, String url, RequestParams params, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(Context context, String url, HttpEntity entity, String contentType, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(String url, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(String url, RequestParams params, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(Context context, String url, RequestParams params, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(Context context, String url, HttpEntity entity, String contentType, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(Context context, String url,Header[] headers, HttpEntity entity, String contentType, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void delete(String url, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void delete(Context context, String url, TGHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void delete(Context context, String url, Header[] headers, TGHttpResponseHandler responseHandler) {
        final HttpDelete delete = new HttpDelete(url);
    ...
    // Private stuff
    protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, TGHttpResponseHandler responseHandler, Context context) {
        if(contentType != null) {
            uriRequest.addHeader("Content-Type", contentType);
        }

        Future<?> request = threadPool.submit(new TGHttpRequest(client, httpContext, uriRequest, responseHandler,responseUrl));
